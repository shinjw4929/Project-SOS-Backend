...
| 서비스 | 기술 스택 | 역할 |
|--------|----------|------|
| Queue Server | C++ / Boost.Asio / Protobuf | 매칭 대기열, 토큰 발급 |
| Chat Server | C++ / Boost.Asio / Protobuf | 인게임 채팅 (로비/팀/전체/귓속말) |
...
| [대기열 서버 구축 계획](docs/계획/대기열%20서버/C++%20대기열%20서버%20구축%20계획.md) | Queue Server 설계 및 구현 계획 |
